...
function MentorTakeAndResolveTicket() {
  ...
  const handleResolve = async () => {
    ...
    try {
           const response = await axios.put(`${API_BASE_URL}/mentor/take-and-resolve-ticket/${ticketNumberAsNumber}`, { solution:  solution}, {
        headers: {
...
export default MentorTakeAndResolveTicket;
